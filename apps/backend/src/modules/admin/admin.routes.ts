...
router.get('/consultants/verified', adminController.getVerifiedConsultants);
router.get('/consultants/:consultantId/detail', ...commonValidations.mongoId('consultantId'), adminController.getConsultantDetailForAdmin);
